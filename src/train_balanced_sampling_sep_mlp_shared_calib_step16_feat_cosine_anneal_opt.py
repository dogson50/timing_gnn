r"""Step16 (revised): step5a_feat backbone + cosine scheduler + mild anneal.

This script keeps step5a_feat as the core pipeline and only adds a mild cosine
schedule plus conservative source-loss annealing.
"""
...
def _apply_step16_defaults(options):
    ...
    print(
        ...
        f"cosine=(T0={options.cosine_t0},Tmult={options.cosine_t_mult},eta_min={options.cosine_eta_min})"
    )


if __name__ == "__main__":
    options = get_options()
    _apply_step16_defaults(options)
