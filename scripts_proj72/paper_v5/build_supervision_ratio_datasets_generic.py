...
def parse_args():
    ...
    p.add_argument("--prefix", type=str, required=True,
                   help="output dataset prefix, e.g. dataset_table_group_train_val_no_test")
...
def main():
    ...
    for r in args.ratios:
        ...
        tag = fmt_ratio_tag(r)
        out_name = f"{args.prefix}_sup{tag}.pkl"
    ...
    out_csv = out_dir / f"{args.prefix}_supervision_ratio_datasets.csv"
